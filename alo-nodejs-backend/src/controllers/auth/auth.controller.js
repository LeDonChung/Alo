...
// };
exports.register = async (req, res) => {
    const { phoneNumber, fullName, password, rePassword } = req.body;
    ...
    // Kiểm tra mật khẩu nếu có rePassword
    if (rePassword && password !== rePassword) {
      return res.status(400).json({ status: 400, message: 'Mật khẩu không khớp.', data: null });
    }
